...
<body id="page-top" class="index">
   ...
   <nav  class="navbar navbar-expand-lg fixed-top navbar-custom ">
      ...
      <a class="navbar-brand navbar-bran text-danger font" href="#">Expeira</a>
      ...
      <div class="container text-center">
        ...
        <div class="row">
          <div class="col-sm col-md-4">
            <img class="img-fluid rounded-circle mag" src="img/s.jpg"  />
            <p><b>CEO</b></p>
          </div>
          <div class="col-sm col-md-4">
          ...
          <div class="col-sm col-md-4">
            <img class="img-fluid rounded-circle mags" src="img/the1.jpg"  />
            <p><b>TV Editor</b></p>
          </div>
        </div>
